//! Reading the Postgres catalog: what tables, indexes, keys and roles exist.

use super::Connection;
use crate::types::{
    ColumnConstraint, ColumnInfo, ConstraintKind, ForeignKeyAction, ForeignKeyInfo, GeneratedKind,
    IdentityKind, IndexInfo, RelationKind, RelationStructure, RoleInfo, TableInfo, TablePrivilege,
};
